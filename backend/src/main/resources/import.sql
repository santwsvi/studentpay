...
-- ========================
-- Senha: aluno123
INSERT INTO usuarios (id, nome, email, login, senha_hash, ativo, tipo_usuario) VALUES ('c1b2c3d4-0010-0010-0010-000000000010', 'Victor Gabriel', 'victor@pucminas.br', 'victor.gabriel', '$2a$10$y7b/gl3T2JVxKPn2bha8c.dYb0IlsNTtyGxnFA6t1hqNcrm9FQ58G', true, 'aluno');
...
INSERT INTO usuarios (id, nome, email, login, senha_hash, ativo, tipo_usuario) VALUES ('c1b2c3d4-0011-0011-0011-000000000011', 'Ana Souza', 'ana.souza@pucminas.br', 'ana.souza', '$2a$10$y7b/gl3T2JVxKPn2bha8c.dYb0IlsNTtyGxnFA6t1hqNcrm9FQ58G', true, 'aluno');
...
INSERT INTO usuarios (id, nome, email, login, senha_hash, ativo, tipo_usuario) VALUES ('c1b2c3d4-0012-0012-0012-000000000012', 'Pedro Lima', 'pedro.lima@ufmg.br', 'pedro.lima', '$2a$10$y7b/gl3T2JVxKPn2bha8c.dYb0IlsNTtyGxnFA6t1hqNcrm9FQ58G', true, 'aluno');
...
-- ========================
-- Senha: empresa123
INSERT INTO usuarios (id, nome, email, login, senha_hash, ativo, tipo_usuario) VALUES ('c1b2c3d4-0020-0020-0020-000000000020', 'TechBH', 'contato@techbh.com', 'techbh', '$2a$10$Xf1ZgtJ0UiBVQwgrumEuIueVYNhbp89BXtc2PFmqMeoAUpgahQNo2', true, 'empresa');
...
INSERT INTO usuarios (id, nome, email, login, senha_hash, ativo, tipo_usuario) VALUES ('c1b2c3d4-0021-0021-0021-000000000021', 'Livraria PageOne', 'contato@pageone.com', 'pageone', '$2a$10$Xf1ZgtJ0UiBVQwgrumEuIueVYNhbp89BXtc2PFmqMeoAUpgahQNo2', true, 'empresa');
